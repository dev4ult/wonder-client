  ...
  return (
    <div className="mx-auto max-w-3xl mt-10">
      <div className="mx-auto max-w-3xl mt-10">
        ...
        <div className="animate-pulse flex justify-between gap-5 my-10 border-y-2 py-3">
          <div className="flex gap-5">
            <div className="flex items-center gap-2">
              <div className=" bg-gray-300 w-7 h-7 rounded-full"></div>
              <div className=" bg-gray-300 h-2 rounded w-5"></div>
            </div>
          ...
          <div className="flex gap-2 items-center ">
            <div className=" bg-gray-300 w-7 h-7 rounded-full"></div>
            <div className=" bg-gray-300 h-2 rounded w-20"></div>
          </div>
        </div>
        <div className="animate-pulse mt-4">
          {LoopParagraphLine(4)}
          <div className=" bg-gray-300 rounded-full w-1/2 h-3 my-5"></div>
          <div className="mt-8">
            <div className=" bg-gray-300 rounded-full w-3/4 h-6 mb-6"></div>
            {LoopParagraphLine(9)}
            <div className=" bg-gray-300 rounded-full w-1/2 h-3 my-5"></div>
          </div>
          <div className=" bg-gray-300 h-[30rem] w-full rounded"></div>
          <div className="mt-8">
            <div className=" bg-gray-300 rounded-full w-3/4 h-6 mb-6"></div>
            {LoopParagraphLine(7)}
            <div className=" bg-gray-300 rounded-full w-1/2 h-3 my-5"></div>
