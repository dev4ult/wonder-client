      ...
      <div className="mx-auto max-w-3xl mt-10">
        ...
        <div className="flex justify-between gap-5 my-10 border-y-2 py-3 text-black/50">
          ...
          <Link to={'/profile'} className="flex gap-2 items-center hover:text-black cursor-pointer">
            ...
            <span className="font-medium  text-lg ">siSarbin</span>
          </Link>
        </div>
        <div id="article-content" className="mt-4 text-lg">
          ...
          <div>
            ...
            <p className="leading-8">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quo earum rerum et amet, aut, autem aliquid asperiores excepturi incidunt doloremque sunt quasi. A velit ut voluptatem labore quam amet aspernatur numquam ullam facilis
              vel rerum corrupti fugiat, deserunt atque deleniti explicabo placeat cumque nostrum iure distinctio similique magni ratione suscipit. At rem qui soluta repudiandae quaerat esse asperiores aspernatur cupiditate! Iusto
              architecto ullam voluptatum nemo nobis blanditiis a, harum totam aperiam nulla ipsum non vel. Reiciendis deserunt qui possimus voluptas reprehenderit nisi, magnam, quo quam deleniti sapiente, ducimus expedita iste porro
              accusamus consequatur nihil explicabo fuga numquam enim! Non, in!
            </p>
          </div>
          ...
          <div>
            ...
            <p className="leading-8">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quo earum rerum et amet, aut, autem aliquid asperiores excepturi incidunt doloremque sunt quasi. A velit ut voluptatem labore quam amet aspernatur numquam ullam facilis
              vel rerum corrupti fugiat, deserunt atque deleniti explicabo placeat cumque nostrum iure distinctio similique magni ratione suscipit. At rem qui soluta repudiandae quaerat esse asperiores aspernatur cupiditate!
            </p>
          </div>
        </div>
